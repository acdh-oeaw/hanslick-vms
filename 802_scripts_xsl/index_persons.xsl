...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <TEI xmlns="http://www.tei-c.org/ns/1.0">
            ...
            <text>
                <body>
                    <xsl:for-each-group select="collection($collection)//tei:body//tei:persName" group-by="substring(normalize-space(upper-case((@key,.)[.!=''][1])),1,1)">
